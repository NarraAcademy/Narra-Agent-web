# Privacy Policy for Narra Agent

## Introduction

Welcome to Narra Agent, your **AI-Powered Cryptocurrency Investment Assistant**. At Narra Agent, your privacy is of utmost importance to us, and this privacy policy outlines how we collect, use, and protect your personal information when you use our services.

## Information Collection and Use

We collect the following types of data to provide you with a better experience while using Narra Agent:
...
2. **Usage Details**
   ...
   - **What We Collect**: Information about how you use Narra Agent, including your interactions, features accessed, and usage frequency.
   - **Purpose**: To analyze user engagement and improve our services.

3. **Device Information**

   - **What We Collect**: Data regarding the devices you use to access Narra Agent, such as device type, operating system, and browser type.
...
**Copyright Owner**: [narraagent.ai](http://narraagent.ai)
**Email**: [hello@narraagent.ai](mailto:hello@narraagent.ai)

By using Narra Agent, you consent to our privacy policy and agree to its terms. Thank you for trusting us with your information!
